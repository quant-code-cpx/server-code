...
| [实施任务](agent/tasks/README.md) | 30 个独立批次、依赖、并行和验收标准；Batch 001–007 已完成 | 🔧 待实现 |
...
| 文档 | 说明 | 状态 |
| --- | --- | --- |
| [Agent 财务与个股资金流工具测试方案-20260719](design/Agent财务与个股资金流工具测试方案-20260719.md) | Batch 008 三个财报、财务指标与个股资金流 Tool 测试矩阵 | 🔧 待实现 |
