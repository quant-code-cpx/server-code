...
export function createMockPrismaService() {
  const prisma = {
    ...
    aiToolCall: buildModelMock(),
    aiModelCall: buildModelMock(),
    aiSearchSource: buildModelMock(),
    aiCitation: buildModelMock(),
    aiPromptVersion: buildModelMock(),
    aiWorkflowVersion: buildModelMock(),
    ...
    backtestRun: buildModelMock(),
    backtestDailyNav: buildModelMock(),
    backtestTrade: buildModelMock(),
    backtestPositionSnapshot: buildModelMock(),
    backtestRebalanceLog: buildModelMock(),
    backtestWalkForwardRun: buildModelMock(),
    backtestWalkForwardWindow: buildModelMock(),
    backtestComparisonGroup: buildModelMock(),
    factor: buildModelMock(),
    factorSnapshot: buildModelMock(),
    factorSnapshotSummary: buildModelMock(),
    technicalSignalDailySnapshot: buildModelMock(),
    technicalSignalEvent: buildModelMock(),
    ...
    screenerSubscriptionLog: buildModelMock(),
    screenerSubscriptionHit: buildModelMock(),
