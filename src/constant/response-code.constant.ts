export enum ErrorEnum {
  ...
  BACKTEST_UNIVERSE_DATA_UNAVAILABLE = '4005:指定日期无可用的点时股票池快照',
  ...
  AI_MEMORY_NOT_FOUND = '6032:记忆不存在或无权访问',
  AI_MEMORY_VALIDATION_FAILED = '6033:记忆参数或策略校验失败',
  AI_MEMORY_CONFLICT = '6034:记忆状态或版本冲突',
  AI_SUMMARY_VERSION_CONFLICT = '6035:会话摘要版本冲突',
  AI_SUMMARY_VALIDATION_FAILED = '6036:会话摘要校验失败',
  AI_SCHEDULE_NOT_FOUND = '6037:定时研究任务不存在或无权访问',
  AI_SCHEDULE_CONFLICT = '6038:定时研究任务版本或状态冲突',
  AI_NOTIFICATION_CHANNEL_NOT_FOUND = '6039:通知渠道不存在或无权访问',
  AI_NOTIFICATION_DELIVERY_NOT_FOUND = '6040:通知投递不存在或无权访问',
  AI_NOTIFICATION_DELIVERY_CONFLICT = '6041:通知投递当前状态不允许此操作',
  AI_NOTIFICATION_CHANNEL_CONFLICT = '6042:通知渠道版本或状态冲突',
  AI_RESEARCH_REPORT_NOT_FOUND = '6043:研究报告不存在或无权访问',
