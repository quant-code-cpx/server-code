...
| [实施任务](agent/tasks/README.md) | 30 个独立批次、依赖、并行和验收标准；Batch 001–006 已完成 | 🔧 待实现 |
...
| 文档 | 说明 | 状态 |
| --- | --- | --- |
| [Agent 股票市场与自选股工具测试方案-20260719](design/Agent股票市场与自选股工具测试方案-20260719.md) | Batch 007 六个股票、行情、市场、板块与自选股 Tool 测试矩阵 | 🔧 待实现 |
