  ...
  return strictObject(
    {
      ...
      biasFlags: strictObject(
        {
          survivorship: { enum: ['VERIFIED', 'UNVERIFIED'] },
          pointInTimeUniverse: { type: 'boolean' },
          announcementDate: { type: 'boolean' },
          adjustment: { enum: ['VERIFIED', 'UNVERIFIED'] },
          reproducible: { type: 'boolean' },
        },
        ['survivorship', 'pointInTimeUniverse', 'announcementDate', 'adjustment', 'reproducible'],
      ),
      reproducibility: strictObject(
        {
          status: { type: 'string' },
          ...
          manifest: nullableObject(
            {
              engineVersion: { type: 'string' },
              dataContractVersion: { type: 'string' },
              universePolicyVersion: { type: 'string' },
              financialAsOfPolicyVersion: { type: 'string' },
              adjustmentPolicyVersion: { type: 'string' },
              ...
              universeSnapshots: {
                ...
                items: strictObject(
                  ...
                  ['date', 'source', 'version', 'hash', 'memberCount'],
                ),
              },
